...
// GokaRedisBuilder builds redis storage.
func GokaRedisBuilder(client *redis.ClusterClient, namespace string) storage.Builder {
...
func New(client *redis.ClusterClient, hash string) (storage.Storage, error) {
	if client == nil {
